...
<title>EyekandyBrand - No 1 - We are the best company for quality eye lens and frames.</title>
<meta name="description" content="HIGH QUALITY MEDICATED and COMPUTER GLASSES :
We live totally surrounded by screens, spending almost nine hours a day, on average, in front of digital devices.">
<meta name="keywords" content="Glasses, Prescription, Frames, Lens, Drugs">
<meta name="author" content="Eye Kandy Brand">
		...
		<!-- Favicon -->
		<link rel="shortcut icon" href="brandsimage/logo1.png">
        <link rel="icon" type="image/png" href="brandsimage/logo1.png">
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">free ship-on oder over ₦ 60,000.00</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Featured Products</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#cheap" data-toggle="tab">Cheap</a></li>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Kids</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from products where category=5 and subCategory=3");
while ($row=mysqli_fetch_array($ret)) 
{
?>
...
<?php }?>
	...
	<section class="section featured-product inner-xs wow fadeInUp">
		<h3 class="section-title">Frames</h3>
