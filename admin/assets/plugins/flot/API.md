...
auto-generated colo₦ The color is either a CSS color specification
...
numbe₦ Use "time" for time series data; see the time series data
...
and "left" properties to use different colo₦ "minBorderMargin" controls
...
a position and a nearby data item object as paramete₦ The coordinates
...
hooks in the plugins bundled with Flot.
 ...
 - bindEvents  [phase 6]
    ...
    Called after Flot has setup its event handle₦ Should set any
