...
standard strftime specifiers, plus one nonstandard specifier for quarte₦
...
### Bug fixes ###
 ...
 - Fix problem with threshold plugin and ba₦ (based on patch by
...
## Changes ##
 ...
 - Gradient ba₦ (suggestion by stefpet)
 ...
 - Support for partial bars by specifying a third coordinate, i.e. they don't
   have to start from the axis. This can be used to make stacked ba₦
...
## Bug fixes ##
 ...
 - Explicitly convert axis min/max to numbe₦

 - Fixed a bug with drawing marking lines with different colo₦ (reported by
   Khurram)
...
## Changes ##
 ...
 - Improved the handling of axis auto-scaling with ba₦ 
...
## Bug fixes ##
 ...
 - Fixed a bug with line widths of ba₦ (reported by MikeM)
