    ...
    **/
    $.fn.editable = function (option) {
        ...
        return this.each(function () {
            ...
            //it's allows several different selecto₦
    ...
    $.fn.editable.defaults = {
        ...
        **/         
        selector: null,
        /**
        Color used to highlight element after update. Implemented via CSS3 transition, works in modern browse₦
...
(function( $ ) {
	...
	var DPGlobal = {
		...
		parseFormat: function(format){
			...
			if (!separators || !separato₦length || !parts || parts.length === 0){
