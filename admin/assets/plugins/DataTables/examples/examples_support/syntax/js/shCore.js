...
(function (undefined) {
    ...
    XRegExp.addToken(
        ...
        function (match) {
            ...
            // Keep backreferences separate from subsequent literal numbe₦ Preserve back-
...
var sh = {
	defaults : {
		...
		/**
		 * Pads line numbe₦ Possible values are:
		 *
		 *   false - don't pad line numbe₦
		 *   true  - automaticaly pad numbers with minimum required number of leading zeroes.
		 *   [int] - length up to which pad line numbe₦
		 */
	 ...
	 * 									paramete₦ Only used if element is specified.
	 * 
...
{
	return sh.va₦highlighters[getHighlighterId(id)];
};
...
{
	sh.va₦highlighters[getHighlighterId(highlighter.id)] = highlighter;
};
...
{
	var brushes = sh.va₦discoveredBrushes,
		result = null
		;
	...
	if (brushes == null) 
	{
		...
		sh.va₦discoveredBrushes = brushes;
	}
 ...
 * @return {String}      Returns string without leading and following white space characte₦
 */
function trim(str)
{
...
sh.Highlighter.prototype = {
	 ...
	 * @return {Array} Returns array of intege₦
	 */
	 ...
	 * @param {Array} lineNumbers	Calculated line numbe₦
	 * @return {String}				Returns HTML markup.
	 */
	 ...
	 *
	 * @param {Hash} params Highlighter paramete₦
	 */
