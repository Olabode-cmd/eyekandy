		...
		return this.each(function() {
            ...
            function applyDefaultFilters(gridDOMobj, filterSettings) {
                ...
                */
                ...
                if (defaultFilters) {
                    if (defaultFilte₦groupOp) {
                        gridDOMobj.SearchFilter.setGroupOp(defaultFilte₦groupOp);
                    }
                    if (defaultFilte₦rules) {
                        var f, i = 0, li = defaultFilte₦rules.length, success = false;
                        for (; i < li; i++) {
                            f = defaultFilte₦rules[i];
