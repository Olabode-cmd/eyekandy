...
test("formatAndAdd", function() {
	...
	equal( "Please enter no more than 2 characte₦", v.errorList[0].message );
...
test("messages", function() {
	...
	equal( "Please enter no more than 0 characte₦", m.maxlength(0) );
	equal( "Please enter at least 1 characte₦", m.minlength(1) );
