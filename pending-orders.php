...
<?php $query=mysqli_query($con,"select products.productImage1 as pimg1,products.productName as pname,products.id as c,orders.roductId as opid,orde₦quantity as qty,products.productPrice as pprice,products.shippingCharge as shippingcharge,orders.aymentMethod as paym,orde₦orderDate as odate,orde₦id as oid from orders join products on orders.roductId=products.id where orde₦userId='".$_SESSION['id']."' and orders.aymentMethod is null");
$cnt=1;
